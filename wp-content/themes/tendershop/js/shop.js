...
(function(u, p, f, q) {
    ...
    f.extend(b, {
        ...
        open: function(a, c) {
            if (a && (f.isPlainObject(c) || (c = {}), !1 !== b.close(!0))) return f.isArray(a) || (a = x(a) ? f(a).get() : [a]), f.each(a, function(e, d) {
                ...
                "object" === f.type(d) && (d.nodeType && (d = f(d)), x(d) ? (j = {
                    ...
                    isDom: !0,
                    element: d
                }, f.metadata && f.extend(!0, j, d.metadata())) : j = d);
                ...
                i || ("inline" === l ? g ? i = f(s(g) ? g.replace(/.*(?=#[^\s]+$)/, "") : g) : j.isDom && (i = d) : "html" === l ? i = g : !l && (!g && j.isDom) && (l = "inline", i = d));
                f.extend(j, {
                    href: g,
                    type: l,
                    content: i,
        ...
        bindEvents: function() {
            ...
            a && (o.bind("orientationchange.fb" + (m ? "" : " resize.fb") + (a.autoCenter && !a.locked ? " scroll.fb" : ""), b.update), (c = a.keys) && n.bind("keydown.fb", function(e) {
                ...
                for (var h = f(c.target || null), i = !1; h.length && !i && !h.is(".fancybox-skin") && !h.is(".fancybox-wrap");) i = h[0] && !(h[0].style.overflow && "hidden" === h[0].style.overflow) && (h[0].clientWidth && h[0].scrollWidth > h[0].clientWidth || h[0].clientHeight && h[0].scrollHeight > h[0].clientHeight), h = f(h).parent();
        ...
        trigger: function(a, c) {
            ...
            if (d) {
                ...
                d.helpers && f.each(d.helpers, function(c, e) {
        ...
        _loadIframe: function() {
            var a = b.coming,
                c = f(a.tpl.iframe.replace(/\{rnd\}/g, (new Date).getTime())).attr("scrolling", m ? "auto" : a.iframe.scrolling).attr("src", a.href);
        ...
        _setDimension: function() {
            ...
            if ("iframe" === h.type) {
                if (E = h.content, h.autoHeight && 1 === E.data("ready")) try {
                    E[0].contentWindow.document.location && (g.width(A).height(9999), D = E.contents().find("body"), q && D.css("overflow-x", "hidden"), y = D.height())
                } catch (F) {}
            ...
            } else d = Math.max(l, Math.min(d, m)), i = Math.max(t, Math.min(i, n));
            if (h.fitToView)
        ...
        _getPosition: function(a) {
            ...
            c.autoCenter && c.fixed && !a && g <= e.h && f <= e.w ? d.position = "fixed" : c.locked || (d.top += e.y, d.left += e.x);
    ...
    b.transitions = {
        getOrigPosition: function() {
            ...
            x(e) ? (d = e.offset(), e.is("img") && (f = e.outerWidth(), g = e.outerHeight())) : (d.top = l.y + (l.h - g) * a.topRatio, d.left = l.x + (l.w - f) * a.leftRatio);
        ...
        changeOut: function() {
            var a = b.previous,
                ...
                d = b.direction;
            "elastic" === c && (e["down" === d || "up" === d ? "top" : "left"] = ("up" === d || "left" === d ? "-" : "+") + "=200px");
            a.wrap.animate(e, {
    ...
    b.helpers.title = {
        beforeShow: function(a) {
            ...
            if (s(c) && "" !== f.trim(c)) {
                ...
                "top" === a.position ? c.prependTo(e) : c.appendTo(e)
            }
        }
    };
    f.fn.fancybox = function(a) {
        var c, e = f(this),
            ...
            a = a || {};
        c = a.index || 0;
        !d || !1 === a.live ? e.unbind("click.fb-start").bind("click.fb-start", j) : n.undelegate(d, "click.fb-start").delegate(d + ":not('.fancybox-item, .fancybox-nav')", "click.fb-start", j);
        return this
    };
    n.ready(function() {
        ...
        if (f.support.fixedPosition === q) {
            var a = f.support,
                ...
                e = 20 === c[0].offsetTop || 15 === c[0].offsetTop;
            c.remove();
            a.fixedPosition = e
        }
        f.extend(b.defaults, {
    ...
    $.fn[flexsliderManualDirectionControls] = function(options) {
        return this.each(function() {
            if (!$.data(this, 'plugin_' + flexsliderManualDirectionControls)) {
                $.data(this, 'plugin_' + flexsliderManualDirectionControls, new FlexsliderManualDirectionControls(this, options));
            }
        });
    };
